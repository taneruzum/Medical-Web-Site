              ...
              services.map((service, index) => (
                <div className='servicesItem' key={index}>
                  ...
                  <div className='additional-content'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi corporis similique facilis repellendus beatae, modi, officiis fuga dolorum quibusdam soluta nulla a labore ducimus quas doloremque dignissimos? Distinctio, alias dolorum.
                  </div>
                </div>
              ))
            }
