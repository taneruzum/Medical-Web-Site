...
const Communication = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Check if the scroll event has already been handled once
      if (scrollPosition > 300 && !scrollEventRef.current) {
        setVisible(true)
        scrollEventRef.current = true
        return
      }

      // When the scroll position goes back below 300, reset the scrollEventRef
  ...
  useEffect(() => {
    ...
    if (visible) {
      setTimeout(handleClose, 100000) // 5 saniye sonra kapat
    }
  }, [visible, isClosed])
  const checkVisible = () => {
    setVisible(!visible)
  ...
  return (
    <>
      <div className={`containerComm ${visible ? 'active' : 'unactive'}`}>
        <svg
        ...
        <div className="containerHeader">
          ...
          <div className="xMarker" onClick={checkVisible}>
        ...
        <div className="containerCommContents">
          <div className="wpbg">
            <img src="./images/wpbg.png" alt="wpLogo" />
          </div>
