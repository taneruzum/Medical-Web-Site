...
const Communication = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            setVisible(scrollPosition >= 200 && !isClosed);
        };
    ...
    useEffect(() => {
        ...
        if (visible && !isClosed) {
            setTimeout(handleClose, 5000); // 5 saniye sonra kapat
        }
    }, [visible, isClosed]);
